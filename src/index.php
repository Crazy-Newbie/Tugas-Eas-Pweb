...
<body class="relative flex">
    ...
    <div class="pt-[94px] ml-[18rem]">
        ...
        <!-- To-do List Cards -->
        <div class="pt-12">
            <h1 class="text-5xl title-card tracking-wider title-card">To-do List</h1>
        </div>

        <!-- Card -->
        <div class="pt-8 flex gap-x-14">
            <div class="bg-[#EAEDF6] w-[16rem] h-[15rem] flex flex-col pl-8 rounded-2xl">
                <div class="flex flex-col mt-8 mb-10">
                    <span class="text-xl">Bayu Adjie <br>Sidharta</span>
                    <span class="text-xs text-[#8E9BB1]">Parent Creation</span>
                </div>
                <div>
                    <a class="flex flex-row" href="">
                        <div class="text-xl">Waiting for Parent <br> Account</div>
                        <img class="w-2 h-3.5 mt-9 absolute ml-20" src="/src/images/arrow-right.png" alt="">
                    </a>
                </div>
            </div>
            <div class="bg-[#EAEDF6] w-[16rem] h-[15rem] flex flex-col pl-8 rounded-2xl">
                <div class="flex flex-col mt-8 mb-10">
                    <span class="text-xl">Melanchton<br>Bonifacio</span>
                    <span class="text-xs text-[#8E9BB1]">Parent Creation</span>
                </div>
                <div>
                    <a class="flex flex-row" href="">
            ...
            <div class="bg-[#EAEDF6] w-[16rem] h-[15rem] flex flex-col pl-8 rounded-2xl">
                <div class="flex flex-col mt-8 mb-10">
                    <span class="text-xl">Bayu Adjie <br>Sidharta</span>
                    <span class="text-xs text-[#8E9BB1]">Epayslip Generation</span>
                </div>
                <div>
                    <a class="flex flex-row" href="">
                        <div class="text-xl">Waiting for Epayslip <br> Account</div>
                        <img class="w-2 h-3.5 mt-9 absolute ml-20" src="/src/images/arrow-right.png" alt="">
                    </a>
                </div>
            </div>
        ...
        <!-- Student Management -->
        <div class="pt-12 flex gap-x-[32rem]">
            <div>
                <h1 class="text-5xl title-card tracking-wide">Student Management</h1>
            </div>
            <div class="pt-6 text-xl">
                <a class="detail" href="student-management.php">See details</a>
            </div>
        </div>
                ...
                <form class="text-xl mt-8 ml-11" action="">
                    ...
                    <div class="mt-5 flex space-x-52">
                        ...
                        <div>
                            ...
                            <input class="ml-2 border-b-2 w-[28.5rem] border-[#C4C4C4] bg-white text-sm text-[#8E9BB1] focus:outline-none" type="text" id="address" name="address"><br>
                        </div>
                    </div>
                    <div class="mt-5 flex">
                        <div>
                        ...
                        <div class="ml-16">
                            ...
                            <input class="ml-2 w-64 border-b-2 border-[#C4C4C4] bg-white text-sm text-[#8E9BB1] focus:outline-none" type="text" id="nis" name="nis"><br>
                        </div>
        ...
        <!-- Parent Creation -->
        <div class="pt-12 flex gap-x-[40rem]">
            <div>
                <h1 class="text-5xl title-card tracking-wide">Parent Creation</h1>
            </div>
            <div class="pt-6 text-xl">
                <a class="detail" href="parent-creational.php">See details</a>
            </div>
        </div>
